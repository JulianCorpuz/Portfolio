...
export default function Navigation() {
  ...
  return (
    <nav className="w-full backdrop-blur-md
                   ...
                   smooth-transition
                   animate-slide-down
                   bg-dark-card/95 nav-light">
      <div className="max-w-7xl mx-auto flex items-center gap-2">
        <ul className="flex-1 flex justify-center lg:justify-start lg:gap-8 gap-1 sm:gap-2 overflow-x-auto">
              ...
              <li key={item.id} style={{animationDelay: `${index * 0.1}s`}} className="animate-fade-in flex-shrink-0">
                <Link
                  ...
                  className={`
                    ...
                    py-1.5 sm:py-3 px-2 sm:px-4 md:px-5
                    ...
                    ${isActive
                      ...
                      : 'text-text-lighter hover:text-accent-gold hover:border-dark-border hover:border'
                    }
                  `}
                >
                  ...
                  <span className="text-lg sm:text-xl md:text-lg group-hover:animate-bounce-light flex-shrink-0">{item.icon}</span>
                  <span className="hidden sm:inline text-xs sm:text-sm md:text-base">{item.label}</span>
